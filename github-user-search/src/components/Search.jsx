        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-200 p-4">
            ...
            >
                ...
                <input
                    ...
                    className="mb-4 w-full px-4 py-3 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder-300 text-blue-900 bg-blue-50 font-semibold shadow-sm"
                />
                <input
                    type="text"
                ...
                <input
                    ...
                    className="mb-6 w-full px-4 py-3 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder-300 text-blue-900 bg-blue-50 font-semibold shadow-sm"
                />
                <button
                    type="submit"
