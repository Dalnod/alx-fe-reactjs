...
function Homepage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-wrap items-center justify-center p-4 gap-6">
            {data.map((recipeData) => {
                const isFavorite = favorites.includes(recipeData.id);
                return (
                    <div key={recipeData.id} className="bg-white rounded-xl shadow-lg overflow-hidden max-w-sm w-full hover:shadow-xl transition-shadow duration-300">
                        {/* Recipe Image */}
